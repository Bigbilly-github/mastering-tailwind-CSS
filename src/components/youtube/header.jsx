        ...
        <>
          <header className='flex bg-black h-[78px] w-full justify-between items-center fixed top-0 left-0 right-0 z-50' >
              <div className='flex items-center w-[220px] pl-[30px] mr-[40px] gap-4 min-w-[180px]'>
                    <div className=' cursor-pointer   hover:border hover:rounded-full hover:border-slate-800 p-1 hover:bg-slate-900'>
                ...
                <div className='flex flex-grow  flex-shrink  min-w-16 max-w-2xl ml-3 sm:mr-5' >
                    ...
                    <div className='sm:w-[70px] w-[30px] cursor-pointer flex-shrink-0 sm:min-w-16 flex items-center justify-center sm:bg-slate-900 sm:border sm:border-slate-700 sm:rounded-r-[25px] '>
                        <img src={search} className='h-[25px]'/>
                    </div>
                    <div className='sm:bg-slate-900 sm:rounded-full sm:ml-[20px] cursor-pointer   hover:bg-slate-800  ml-1 flex-shrink-0 sm:mr-4 mr-1 sm:border sm:border-slate-800 p-2'>
                ...
                <div className='flex items-center justify-evenly gap-2  w-[200px] flex-shrink-0 sm:ml-2 sm:mr-5 mr-3'>
                    ...
                    <div className='relative  hover:bg-slate-800 hover:rounded-full p-1.5'>
